...
class MainMenuState extends MusicBeatState
{
   ...
   var menuDisplay:FlxText;
	...
	override function create()
	{
		...
		add(menuItems);
menuDisplay = new FlxText(0, 0, 1280, "STORY MODE", 48);
menuDisplay.setFormat("VCR OSD Mono", 48, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
menuDisplay.scrollFactor.set();
menuDisplay.cameras = [camHUD];
add(menuDisplay);
...
function updateMenuDisplay()
{
    ...
    {
        case 'story_mode':
            menuDisplay.text = "STORY MODE";

        case 'freeplay':
            menuDisplay.text = "FREEPLAY";

        case 'mods':
            menuDisplay.text = "MODS";

        case 'awards':
            menuDisplay.text = "AWARDS";

        case 'credits':
            menuDisplay.text = "CREDITS";

        case 'options':
            menuDisplay.text = "OPTIONS";
    }
}
}
